...
create_and_configure_core -core_vlnv {Actel:SgCore:PF_INIT_MONITOR:2.0.105} -component_name {PF_INIT_MONITOR_0} -params {\
...
# Exporting core PF_INIT_MONITOR_0 to TCL done
