# Create and Configure the core component MIV_ESS_DGC2_C0
create_and_configure_core -core_vlnv {Actel:SystemBuilder:MIV_ESS:*} -download_core -component_name {MIV_ESS_DGC2_C0} -params {\
...
"WRITE_PORT:1" \
"uDMA_EN:false" }
# Exporting Component Description of MIV_ESS_DGC2_C0 to TCL done
